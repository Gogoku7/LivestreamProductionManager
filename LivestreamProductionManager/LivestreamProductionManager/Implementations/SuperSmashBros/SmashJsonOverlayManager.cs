    ...
    public class SmashJsonOverlayManager : ISmashOverlayManager
    {
        ...
        public void UpdateSinglesOverlay(SinglesViewModel singlesViewModel)
        {
            try
            {
                ...
                singlesCssModel.Player1.CharacterPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#player1Character", singlesViewModel.Player1.Character ?? "../../CharacterIcons/random.png");
                singlesCssModel.Player1.PortPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#player1Port", singlesViewModel.Player1.Port ?? "../../PlayerPorts/playerPortNo.png");
                ...
                singlesCssModel.Player2.CharacterPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#player2Character", singlesViewModel.Player2.Character ?? "../../CharacterIcons/random.png");
                singlesCssModel.Player2.PortPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#player2Port", singlesViewModel.Player2.Port ?? "../../PlayerPorts/playerPortNo.png");
        ...
        public void UpdateCrewsOverlay(CrewsViewModel crewsViewModel)
        {
            try
            {
                ...
                crewsCssModel.Crew1.CharacterPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#crew1Character", crewsViewModel.Crew1.Character ?? "../../CharacterIcons/random.png");
                crewsCssModel.Crew1.PortPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#crew1Port", crewsViewModel.Crew1.Port ?? "../../PlayerPorts/playerPortNo.png");
                ...
                for (var i = 0; i < crewsViewModel.Crew1.Players.Count; i++)
                {
                    ...
                    crewsCssModel.Crew1.CrewPlayerCssModels[i].CharacterPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, $"#crew1Player{i + 1}Character", crewsViewModel.Crew1.Players[i].Character ?? "../../CharacterIcons/random.png");
                }

                crewsCssModel.Crew2.Name = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#crew2NameText", crewsViewModel.Crew2.Name ?? "");
                crewsCssModel.Crew2.CharacterPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#crew2Character", crewsViewModel.Crew2.Character ?? "../../CharacterIcons/random.png");
                crewsCssModel.Crew2.PortPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#crew2Port", crewsViewModel.Crew2.Port ?? "../../PlayerPorts/playerPortNo.png");
                ...
                for (var i = 0; i < crewsViewModel.Crew2.Players.Count; i++)
                {
                    ...
                    crewsCssModel.Crew2.CrewPlayerCssModels[i].CharacterPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, $"#crew2Player{i + 1}Character", crewsViewModel.Crew2.Players[i].Character ?? "../../CharacterIcons/random.png");
                }
        ...
        public void UpdateSquadStrikeOverlay(SquadStrikeViewModel squadStrikeViewModel)
        {
            try
            {
                ...
                squadStrikeCssModel.Squad1.PortPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#squad1Port", squadStrikeViewModel.Squad1.Port ?? "../../PlayerPorts/playerPortNo.png");
                ...
                squadStrikeCssModel.Squad2.PortPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, "#squad2Port", squadStrikeViewModel.Squad2.Port ?? "../../PlayerPorts/playerPortNo.png");
                ...
                for (var i = 0; i < squadStrikeViewModel.Squad2.Players.Count; i++)
                {
                    ...
                    squadStrikeCssModel.Squad2.SquadPlayerCssModels[i].CharacterPath = _textReplacer.ReplaceIdAndValue(_textTemplateJson, $"#squad2Character{i + 1}", squadStrikeViewModel.Squad2.Players[i].Character ?? "../../CharacterIcons/random.png");
